...
wget https://github.com/rabbitmq/rabbitmq-autocluster/releases/download/0.8.0/autocluster_aws-0.8.0.ez -P /usr/lib/rabbitmq/lib/rabbitmq_server-$RABBITMQ_VERSION/plugins/ && \
